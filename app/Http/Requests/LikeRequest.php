...
class LikeRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('like', $this->likeableInstance());
    }
    ...
    public function likeableInstance(): Likeable
    {
        $class = $this->input('likeable_type');

        return $class::findOrFail($this->input('id')); // finding specific instance of the model.
    }
}
