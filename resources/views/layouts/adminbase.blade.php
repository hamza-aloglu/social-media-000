...
<head>
    ...
    <!-- Magnific popup -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets-admin')}}/js/plugins/magnific/magnific-popup.css">
    <!-- c3charts -->
...
@section('scripts')
    ...
    <script src="{{asset('assets-admin')}}/js/plugins/magnific/jquery.magnific-popup.js"></script>
    <!-- Plugins -->
    <script src="{{asset('assets-admin')}}/js/plugins/c3charts/d3.min.js"></script>
    <script src="{{asset('assets-admin')}}/js/plugins/c3charts/c3.min.js"></script>
    <script src="{{asset('assets-admin')}}/js/plugins/circles/circles.js"></script>
    <!-- Jvectormap JS -->
